...
PLAYER_PETS_DATABASE.Add(PETS_DATABASE.FindById(6).pet)
...
PLAYER_PETS_DATABASE.Add(PETS_DATABASE.FindById(3).pet)
PLAYER_PETS_DATABASE.Add(PETS_DATABASE.FindById(7).pet)
